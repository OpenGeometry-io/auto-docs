...
graph TD
    ...
    C -->|Compiled to WASM| B["WebAssembly Module\n(opengeometry.wasm)"]
    B -->|WASM bindings| A["TypeScript / Three.js Layer\n(Browser / Node.js)"]
    A -->|Renders to| V["App View\n(Interactive 3D Canvas)"]

    style C fill:#E8590C,stroke:#C73E00,color:#fff,stroke-width:3px
...
<CardGroup cols={2}>
  <Card title="Primitives and Shapes" icon="draw" href="/concepts/primitives-and-shapes">
    Explore the available 2D and 3D primitives you can create
  </Card>
  <Card title="CAD Operations" icon="cogs" href="/concepts/operations">
      Learn about extrusion, offsetting, sweeping, and more
  </Card>
  <Card title="Boundary Representation" icon="cube" href="/concepts/brep">
    Understand how BREP works and how to build complex geometry
  </Card>
  <Card title="Booleans" icon="union" href="/concepts/booleans">
