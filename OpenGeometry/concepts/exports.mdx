...
- [STL export](/OpenGeometry/api/export/stl) (experimental)
- [IFC export](/OpenGeometry/api/export/ifc) (experimental)
- [Projection & hidden line removal](/OpenGeometry/api/export/projection) (experimental)
- [STEP export](/OpenGeometry/api/export/step) (experimental)
- [PDF export](/OpenGeometry/api/export/pdf) (experimental)
