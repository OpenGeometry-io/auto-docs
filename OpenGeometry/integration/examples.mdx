...
Live interactive demos: **[demos.opengeometry.io](https://demos.opengeometry.io/)**
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-polygon.ts:1
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-cuboid.ts:1

#### Cylinder

Parametric cylinder with radius and height adjustments.

**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-cylinder.ts

#### Sphere

Sphere with tessellation quality controls.

**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-sphere.ts
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-sweep.ts:1
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/operations-offset.ts

#### Wall from Offsets

Generate architectural walls with thickness.

**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/operations-wall-from-offsets.ts

#### Opening Operations

Create openings in walls and solids.

**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/pages/shapes-opening.ts
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/shared/runtime.ts:53
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/shared/runtime.ts:168
...
**Source:** ~/workspace/source/main/opengeometry/examples-vite/src/shared/runtime.ts:154
