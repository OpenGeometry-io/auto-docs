...
- [Projection](/OpenGeometry/api/export/projection) — Converting 3D scenes to 2D drawings
- [PDF export](/OpenGeometry/api/export/pdf) — Exporting scenes to PDF format
- [Line](/OpenGeometry/api/primitives/line) — Basic 2D geometry that can be added to scenes
