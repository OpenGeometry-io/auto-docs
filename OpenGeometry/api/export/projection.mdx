...
<Warning>
Projection and hidden line removal are experimental. Output and option shapes may change. If you hit
...
OpenGeometry derives edge adjacency from the B-Rep half-edge topology.
...
- [Scene Management](/OpenGeometry/api/scene/scene-management) - Organizing multiple entities
- [PDF Export](/OpenGeometry/api/export/pdf) - Exporting projections to PDF
- [BRep](/OpenGeometry/concepts/brep) - Boundary representation structure