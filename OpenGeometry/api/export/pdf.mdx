...
confusing output, reach out on [Discord](https://discord.gg/cZY2Vm6E).
</Warning>
...
// Create geometry
let mut cuboid = OGCuboid::new("cuboid-1".to_string());
cuboid
    .set_config(Vector3::new(0.0, 0.0, 0.0), 5.0, 3.0, 2.0)
    .unwrap();
...
- [Projection](/OpenGeometry/api/export/projection) - Creating 2D scenes from 3D geometry
