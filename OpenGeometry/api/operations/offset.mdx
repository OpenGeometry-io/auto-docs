...
<CardGroup cols={2}>
  <Card title="Sweep" icon="route" href="/OpenGeometry/api/operations/sweep">
    Offset a profile along a path
  </Card>
  <Card title="Extrude" icon="arrows-up-down" href="/OpenGeometry/api/operations/extrude">
...
<Card title="Offset Demo" icon="play" href="https://demos.opengeometry.io/operations/offset.html">
